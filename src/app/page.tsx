            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 grid grid-cols-3 grid-rows-2 gap-3">
                <Link href="/polizas" className="w-full h-full">
                  <Button variant="outline" className="w-full h-full flex-col gap-1 hover:bg-[#59CBE8]/10 text-zinc-700 bg-gradient-to-br from-white to-[#59CBE8]/25 border-[#59CBE8]/30 shadow-sm transition-all hover:shadow-md py-1 group">
                ...
                <Button
                  variant="outline"
                  className="w-full h-full flex-col gap-1 hover:bg-[#59CBE8]/10 text-zinc-700 bg-gradient-to-br from-white to-[#59CBE8]/25 border-[#59CBE8]/30 shadow-sm transition-all hover:shadow-md py-1 group"
                ...
                <Button
                  variant="outline"
                  className="w-full h-full flex-col gap-0.5 hover:bg-[#59CBE8]/10 text-zinc-700 bg-gradient-to-br from-white to-[#59CBE8]/25 border-[#59CBE8]/30 shadow-sm transition-all hover:shadow-md px-1 py-1 group"
                  onClick={() => setIsEditClienteOpen(true)}
                >
                  <UserCog className="h-4 w-4 text-zinc-500 group-hover:text-[#59CBE8] transition-colors" />
